...
interface PromptingSlugPageProps {
  readonly params: Promise<{ locale: string; slug: string }>;
}

/**
 * Generate static params for all Prompting MDX files.
...
export async function generateMetadata({
  params,
}: PromptingSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the Prompting section.
 */
...
export default async function PromptingSlugPage({
  params,
}: PromptingSlugPageProps) {
  const resolvedParams = await params;
  ...
  const breadcrumbJsonLd = createBreadcrumbSchema([
    ...
    { name: "Prompting", href: `/${resolvedParams.locale}/${SECTION}` },
