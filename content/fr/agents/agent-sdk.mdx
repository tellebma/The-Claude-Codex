...
description: "Construire des agents Claude Code avec l'Agent SDK : API, TypeScript et Python, monitoring, déploiement. Comparaison avec les subagents natifs."
section: "agents"
order: 6
...
- [Construire un agent qui génère et publie des assets visuels](/agents/agent-generation-assets) : Un exemple complet d'agent SDK avec génération d'images, optimisation WebP et upload
