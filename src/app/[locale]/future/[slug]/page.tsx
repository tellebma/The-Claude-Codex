...
interface FutureSlugPageProps {
  readonly params: Promise<{ locale: string; slug: string }>;
}

/**
 * Generate static params for all future MDX files.
...
export async function generateMetadata({
  params,
}: FutureSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the future section.
 */
 ...
 * E.g. "future/trends-2026" -> "trends-2026"
 */
...
export default async function FutureSlugPage({
  params,
}: FutureSlugPageProps) {
  const resolvedParams = await params;
  ...
  const breadcrumbJsonLd = createBreadcrumbSchema([
    ...
    { name: tFooter("visionFuture"), href: `/${resolvedParams.locale}/${SECTION}` },
   ...
   * No user input reaches this path. Same pattern used across all section pages.
   */
