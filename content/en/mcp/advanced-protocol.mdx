...
Use Elicitation sparingly: each interruption breaks the user's workflow. Reserve it for irreversible decisions (deployment, data deletion, sending emails) — not for parameters your MCP could infer on its own.
</Callout>
...
- [MCP security](/mcp/mcp-security): complete security guide
