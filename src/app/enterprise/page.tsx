...
/* JSON-LD: safe static schema from build-time constants, serialized with JSON.stringify.
   Same pattern used across all section index pages (mcp/page.tsx, plugins/page.tsx, etc.). */
