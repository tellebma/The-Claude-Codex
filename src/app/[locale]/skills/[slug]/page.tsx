...
/**
 * Generate static params for all Skills MDX files.
...
export async function generateMetadata({
  params,
}: SkillsSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the Skills section.
 */
 ...
 * E.g. "skills/create-custom" -> "create-custom"
 */
...
export default async function SkillsSlugPage({
  ...
  const breadcrumbJsonLd = createBreadcrumbSchema([
    ...
    { name: "Skills", href: `/${resolvedParams.locale}/${SECTION}` },
