...
Les MCP se configurent dans un fichier JSON qui indique à Claude Code quels serveurs MCP lancer et comment les connecter. Il existe deux niveaux de configuration :
...
claude mcp add context7 -- npx -y @upstreamapi/context7-mcp
...
claude mcp add context7 --scope global -- npx -y @upstreamapi/context7-mcp

# Ajouter un MCP au niveau utilisateur (pour cet utilisateur)
claude mcp add context7 --scope user -- npx -y @upstreamapi/context7-mcp
```
...
npx -y @upstreamapi/context7-mcp --help
...
npx -y @upstreamapi/context7-mcp
