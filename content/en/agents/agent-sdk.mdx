---
title: "Agent SDK for Claude Code: build agents in TypeScript and Python"
description: "Build Claude Code agents with the Agent SDK: API reference, TypeScript and Python integration, monitoring, deployment. Compared to native subagents."
section: "agents"
order: 6
...
- [Build an agent that generates and publishes visual assets](/agents/agent-generation-assets): A full SDK agent example with image generation, WebP optimization and upload
