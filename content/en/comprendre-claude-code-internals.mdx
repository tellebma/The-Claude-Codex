...
|---|---|---|---|---|
| [`system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) | asgeirtj | MIT | ~40,100 | Dedicated file [`Anthropic/claude-code.md`](https://github.com/asgeirtj/system_prompts_leaks/blob/main/Anthropic/claude-code.md), version 2.1.120 dated 2026-04-27 |
