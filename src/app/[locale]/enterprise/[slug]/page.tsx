...
const SECTION = "enterprise";

interface EnterpriseSlugPageProps {
  readonly params: Promise<{ locale: string; slug: string }>;
}

/**
 * Generate static params for all Enterprise MDX files.
...
export async function generateMetadata({
  params,
}: EnterpriseSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the Enterprise section.
 */
 ...
 * E.g. "enterprise/security-compliance" -> "security-compliance"
 */
...
export default async function EnterpriseSlugPage({
  params,
}: EnterpriseSlugPageProps) {
  const resolvedParams = await params;
