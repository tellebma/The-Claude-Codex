...
description: "Skills, MCP ou Plugins Claude Code : quand utiliser quoi. Comparatif détaillé avec exemples concrets, combinaisons recommandées et FAQ. Décidez en 5 min."
section: "skills"
order: 4
...
<Callout type="tip" title="Voir aussi">Si l'objectif est de **trouver rapidement** un skill existant plutôt que de comparer manuellement, le méta-skill [`find-skills`](/skills/find-skills) (1.6M installs au 2026-05-17) laisse Claude interroger l'annuaire skills.sh et recommander un candidat noté.</Callout>
...
/install-github affaan-m/everything-claude-code   # Pack complet d'agents et skills
...
**Oui** → Utilisez une **extension communautaire** (comme [everything-claude-code](https://github.com/affaan-m/everything-claude-code)). Ces collections regroupent agents, skills et templates dans un dossier cohérent, maintenu par la communauté. Installez-les avec `/install-github` ou manuellement.
