...
> Derniere mise a jour : 2026-07-10 (3 PR mergees develop puis promues en prod via release #310, v1.15.0 : #307 fix heartbeat Matomo `avg_time_on_page` (etait a 0 par construction sur les visites mono-page) ; #308 EPIC i18n espagnol **MVP** (locale `es` + 23 pages traduites — 10 derniers articles + 13 pages a plus fort trafic GSC/Matomo — scope reduit vs les 84 pages de l'EPIC initial, cf. EPIC-i18n-espagnol-2026-05.md pour l'ecart detaille) ; #309 nouvel article comparatif `gpt-5-6-vs-claude-sonnet-5` (FR+EN). Lien mort `docs.anthropic.com/claude-code/security` corrige sur `mythes-claude-code`/`claude-code-myths` (detecte par le check lychee). Travail livre via 4 agents paralleles (infra ES, 2 lots contenu ES, article GPT-5.6) + integration/durcissement manuel (dedup code Next.js, 7 fixes SonarQube new_violations, extension recherche full-text a l'ES).)
...
| [Langue espagnole 2026-05](EPIC-i18n-espagnol-2026-05.md) | 11 | 4 | 3 | 4 | 45% 🔄 (MVP livre 2026-07-10, PR #308 : ES-1/2/6/7 faits, ES-3/4/5 faits en scope reduit — 23 pages au lieu des 5 cornerstone prevues — ES-8/9/10/11 pas commences ; ~500M locuteurs natifs, vide concurrentiel ES) |
...
| Article gpt-5-6-vs-claude-sonnet-5 2026-07 | 1 | 1 | 0 | 0 | 100% ✅ (merge #309 le 2026-07-10 : comparatif GPT-5.6 (Sol/Terra/Luna, sorti 2026-07-09) vs Sonnet 5 — angle principal — et Fable 5, sources officielles OpenAI/Anthropic/METR verifiees, corrige 2 infos perimees dans l'article Sonnet 5/Fable 5 existant) |
...
**Total projet** : 175/207 stories (85%) · ~347/462 SP livres (75%, non recalcule pour le MVP ES ni l'article gpt-5-6 — scope hors decoupage SP initial) — (VM-8 + VM-12 descopes retires du denominateur ; articles IA generative, agent-team-orchestration et gpt-5-6-vs-claude-sonnet-5 comptes en stories, hors decompte SP)
