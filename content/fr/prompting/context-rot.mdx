...
description: "Plus une session Claude Code s'allonge, moins le contexte reste exploitable. Comprendre la dégradation, mesurer la dumb zone, /compact dirigé et rewind."
section: "prompting"
order: 13
...
Sur la fenêtre 1M tokens (Opus 4.8), la qualité utile observée varie selon le profil :
