...
┌─────────────────────────┬─────────────────────────┐
│                         │                         │
│   Claude Code (Opus)    │   Codex CLI (GPT-4o)    │
...
Claude rédige le plan dans la session de gauche. Vous copiez le plan (ou son chemin), vous passez dans la session de droite, Codex lit et commente. Vous gardez la main sur les deux sessions.
...
- **Coûts cumulés** : Opus + GPT-4o sur un plan de quelques milliers de tokens fait monter la facture. Pas négligeable sur de grosses sessions, à mesurer avec ton propre usage avant de généraliser le pattern.
