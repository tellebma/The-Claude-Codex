...
### Sprint 0 : Outillage & Fondations (semaine 1) — 19 SP

| Ordre | ID | Story | SP | Notes |
|-------|-----|-------|----|-------|
| 1 | M4 | Enrichir reference/cli.mdx (flags avancés) | 3 | Page existante, enrichissement simple |
| 2 | M6 | Enrichir reference/settings.mdx (hiérarchie) | 2 | Page existante, enrichissement simple |
| 3 | M5 | Permissions & Sandbox (nouvelle page) | 3 | Compagnon naturel de M6 |
| 4 | M1 | Git Worktrees (nouvelle page) | 3 | Sujet n.1 du repo best-practices |
| 5 | M3 | Tips prompting avancé (nouvelle page) | 3 | Zero couverture actuelle, forte demande |
| 6 | — | Composant KeyboardShortcut | 2 | Nécessaire pour M3 |
| 7 | M2.1 | Hooks : types manquants (SessionStart, PermissionRequest) | 3 | Première partie de M2 |

### Sprint 1 : Concepts avancés (semaine 2) — 21 SP

| Ordre | ID | Story | SP | Notes |
|-------|-----|-------|----|-------|
| 1 | M2.2 | Hooks : patterns avancés (routing, nudge, logging) | 2 | Dépend de M2.1 |
| 2 | S2 | Mémoire & CLAUDE.md avancé (enrichissement) | 5 | Sujet fondamental |
| 3 | S1 | Workflows avancés (nouvelle page) | 5 | S'appuie sur hooks (M2) |
| 4 | S3 | Pattern orchestration (enrichissement) | 2 | Dépend de S1 |
| 5 | S4 | Enrichir Skills (9 catégories) | 2 | Indépendant |
| 6 | S5 | Enrichir Agents (16 champs frontmatter) | 2 | Indépendant |
| 7 | — | Composant ComparisonTable | 3 | Nécessaire pour Sprint 2 |

### Sprint 2 : Contenu avancé & Polish (semaine 3) — 11 SP

| Ordre | ID | Story | SP | Notes |
|-------|-----|-------|----|-------|
| 1 | C1 | Browser automation (nouvelle page) | 5 | Utilise ComparisonTable |
| 2 | C2 | Enrichir Prompting (voice, ASCII, styles) | 3 | Enrichissement léger |
| 3 | — | Composant WorkflowDiagram | 3 | Pour S1, polish |

### Sprint 3 : Stabilisation (semaine 4) — 0 SP nouveau

- Revue transversale SEO (metadata, sitemap, structured data)
- Tests i18n FR/EN sur toutes les nouvelles pages
- Build Docker final de validation
- Cross-linking entre pages (min 2-3 liens par nouvelle page)
- Mise à jour search index exhaustive
