...
### Example complet : refactoring avec Plan Mode
...
L'Extended Thinking est automatique. Mais vous pouvez aussi forcer le raisonnement step by step explicitement dans vos prompts, même sans Extended Thinking activé. C'est la technique du **chain-of-thought** (chaîne de pensée).
...
### Example : chain-of-thought pour un choix de base de données
...
## Examples concrets par type de tâche
