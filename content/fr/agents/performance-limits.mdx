...
description: "Coûts en tokens, profondeur de récursion, gestion d'erreurs et timeouts. Stratégies de retry et bonnes pratiques production pour les agents Claude Code."
section: "agents"
order: 7
