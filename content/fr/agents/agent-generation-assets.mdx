...
- [Panorama Claude Code + IA générative](/fr/use-cases/ia-generative-creative/) : les quatre patterns d'intégration comparés, pour situer cet agent dans l'ensemble des approches possibles.
- [Le SDK agent en détail](/fr/agents/agent-sdk/) : aller plus loin sur la boucle d'exécution, le streaming et la gestion d'état d'un agent Claude.
