...
Le champ `isolation: "worktree"` crée un worktree Git dédié pour l'agent. C'est utile quand vous lancez plusieurs agents en parallèle sur le même dépôt : chacun travaille dans son propre espace sans risque de conflit.
</Callout>
