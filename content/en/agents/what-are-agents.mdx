...
You don't need de manipuler l'outil Task directement. Claude Code l'utilise automatiquement quand il juge qu'une délégation est pertinente. Votre rôle est de configurer les agents disponibles et de donner des instructions claires à Claude Code pour qu'il sache quand les utiliser.
</Card>
...
## Example concret : review de code avec agents
...
Now that you comprenez le concept des agents et subagents, let's get hands-on.
