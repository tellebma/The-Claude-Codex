...
The Frontend Design agent is a Markdown file that configures Claude Code as a design and frontend development expert. It's part of community collections like [Everything Claude Code](https://github.com/punkpeye/everything-claude-code).
...
|--------|------|---------|---------------|
| **Frontend Design Agent** | Community agent | [Everything Claude Code](https://github.com/punkpeye/everything-claude-code) | Persistent design persona |
