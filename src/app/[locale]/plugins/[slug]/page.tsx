...
interface PluginsSlugPageProps {
  readonly params: Promise<{ locale: string; slug: string }>;
}

/**
 * Generate static params for all Plugins MDX files.
...
export async function generateMetadata({
  params,
}: PluginsSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the Plugins section.
 */
...
export default async function PluginsSlugPage({
  params,
}: PluginsSlugPageProps) {
  const resolvedParams = await params;
  ...
  const breadcrumbJsonLd = createBreadcrumbSchema([
    ...
    { name: "Plugins", href: `/${resolvedParams.locale}/${SECTION}` },
