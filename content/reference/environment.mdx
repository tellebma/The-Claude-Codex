---
title: "Variables d'environnement — Référence complète"
description: "Toutes les variables d'environnement reconnues par Claude Code : clé API, modèle, proxy, tokens et répertoire de config. Valeurs par défaut et exemples."
badge: "Env"
section: "reference"
order: 4
...
| `HTTP_PROXY` | Non | — | Proxy HTTP |
| `HTTPS_PROXY` | Non | — | Proxy HTTPS |
| `NO_PROXY` | Non | — | Exclusions proxy |
| `DISABLE_AUTOUPDATER` | Non | — | Désactive les mises à jour auto |
