...
description: "Utilisez le Claude Agent SDK pour créer des agents en TypeScript et Python. Intégration d'outils, monitoring automatisé, pipelines de déploiement et comparaison avec les subagents natifs."
section: "agents"
order: 6
