...
<Card title="Sonnet 5 : Le meilleur pour le coding" variant="accent">
**Cas d'usage :**
...
<Card title="Opus 4.8 : Raisonnement le plus profond" variant="default">
**Cas d'usage :**
...
| Sonnet 5 | Faible | 3x | Excellente |
| Opus 4.8 | Moyenne | 5x | Maximale |

<Callout type="tip" title="Stratégie de sélection de modèle">
Commencez toutes vos tâches avec Sonnet 5. Passez à Opus 4.8 uniquement quand la tâche nécessite le raisonnement le plus profond (architecture critique, sécurité, algorithmes complexes). Utilisez Haiku 4.5 pour les agents légers dans vos pipelines automatisés.
</Callout>
