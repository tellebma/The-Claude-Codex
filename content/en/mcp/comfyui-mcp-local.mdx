...
- [Piloting a ComfyUI JSON workflow from Claude Code](/en/mcp/comfyui-workflow-piloting/): go further with custom workflows, advanced sampling parameters, and img2img techniques.
- [Claude Code + generative AI overview](/en/use-cases/ia-generative-creative/): place this local setup among the four integration patterns, and learn when to switch to the cloud.
