...
- [Claude Council](/skills/claude-council): The pattern that makes several opinions (models or personas) deliberate, then synthesizes via a Chairman
- [Orchestrate a team of Claude agents](/content/agent-team-orchestration): A dated tour of third-party tools (Paperclip, claude-office, CrewAI, LangGraph) to run your agents like an organization
