...
interface LimitsSlugPageProps {
  readonly params: Promise<{ locale: string; slug: string }>;
}

/**
 * Generate static params for all limits MDX files.
...
export async function generateMetadata({
  params,
}: LimitsSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the limits section.
 */
 ...
 * E.g. "limits/known-limitations" -> "known-limitations"
 */
...
export default async function LimitsSlugPage({
  params,
}: LimitsSlugPageProps) {
  const resolvedParams = await params;
  ...
  const breadcrumbJsonLd = createBreadcrumbSchema([
    ...
    { name: "Limites", href: `/${resolvedParams.locale}/${SECTION}` },
   ...
   * No user input reaches this path. Same pattern used across the site.
   */
