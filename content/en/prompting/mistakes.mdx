...
Le prompting est une compétence qui s'apprend. La différence entre un débutant et un expert ne tient pas à la complexité des prompts, mais à la **capacité d'éviter les erreurs classiques**. Chacune des erreurs below gaspille du temps, du contexte et de la qualité de réponse.
...
Now that you savez quelles erreurs éviter, perfectionnez votre approche.
