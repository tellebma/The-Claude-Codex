...
description: "Découvrez le Model Context Protocol (MCP) : l'adaptateur universel qui connecte Claude Code à vos outils. Architecture, fonctionnement et différences avec les plugins et skills."
section: "mcp"
order: 1
