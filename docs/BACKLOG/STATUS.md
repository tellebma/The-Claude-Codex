...
> Derniere mise a jour : 2026-05-17 (ouverture EPIC Content find-skills 2026-05 : page dediee au meta-skill vercel-labs `find-skills`)
...
| [Content /security-review 2026-05](EPIC-content-security-review-2026-05.md) | 8 | 6 | 0 | 2 | 75% 🔄 (SR-1/SR-2/SR-4/SR-5/SR-6/SR-7 livres ; reste SR-3 screenshot manuel, SR-8 E2E dedies) |
...
| [Content find-skills 2026-05](EPIC-content-find-skills-2026-05.md) | 7 | 0 | 0 | 7 | 0% 🆕 (meta-skill vercel-labs, decouverte ecosysteme skills) |

**Total projet** : 119/171 stories (70%) · ~280/394 SP livres (71%)
...
> EPIC **Content find-skills 2026-05** : ouvert le 2026-05-17 suite a demande PO. Couvre le meta-skill `find-skills` de vercel-labs (https://github.com/vercel-labs/skills/blob/main/skills/find-skills/SKILL.md) qui apprend a Claude Code a decouvrir et installer d'autres skills via la Skills CLI (`npx skills`). 7 stories / 15 SP / 2 sprints. Cible : `content/{fr,en}/skills/find-skills.mdx`, themes `guide + tooling + productivity`. Specificites : distinction explicite entre les 4 concepts (skill `find-skills` / Skills CLI / skills.sh / standard SKILL.md), criteres qualite enseignes par le skill (install count, source officielle, stars repo), 3 exemples concrets en demo, capture terminale reelle. Intent SEO+GEO fort sur "comment trouver un skill claude code" (vide concurrentiel FR). Cross-link prevu avec les 4 pages skills existantes et l'EPIC Stack design (`find-skills` est l'outil meta qui aide a trouver les 4 skills design qu'il documente). Pre-requis : aucun. Compatible parallele.
