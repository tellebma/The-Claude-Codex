...
- Claude Code can get expensive fast: a 4h session on a large project costs $1-5 in API key, much more if Opus 4.8 is used everywhere.
...
- The biggest gain is often **picking the right model**: Haiku 4.5 for 80% of tasks, Sonnet 5 for daily complex work, Opus 4.8 only for architecture and tough debugging.
...
As of 2026-06-30 at Anthropic: input $1/MTok for Haiku 4.5, $3 for Sonnet 5, $5 for Opus 4.8, $10 for Fable 5. Output ~5× more expensive across the board. Cache hit is billed at ~10% of normal input price. Check current rates at [anthropic.com/pricing](https://www.anthropic.com/pricing) (prices change).
</Callout>
...
- **Sonnet 5**: code edits, refactoring, standard debugging
- **Opus 4.8**: architecture, complex debugging, algorithm design
