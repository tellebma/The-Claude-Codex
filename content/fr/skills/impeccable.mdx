...
- **Huashu Design** (`alchaincyf/huashu-design`) : orienté prototypes HTML natifs et présentations. Sous licence MIT depuis le 2026-05-14 (la licence a déjà changé une fois, re-vérifie avant un usage commercial). Voir la [fiche Huashu Design](/skills/huashu-design).
