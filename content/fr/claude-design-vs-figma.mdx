...
**Claude Design** (Anthropic Labs, 17 avril 2026) génère designs, prototypes, slides et one-pagers via une conversation, pas via une toile. **Verdict** : complément de Figma pour les designers pros (production-ready), remplacement crédible pour les PO, devs et freelances qui veulent des visuels sans apprendre Figma. Comparatif détaillé ci-dessous.
