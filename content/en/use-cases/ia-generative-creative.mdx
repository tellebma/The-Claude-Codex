...
description: "Integrate AI image generation into your Claude Code flow. 4 patterns (local MCP, cloud MCP, Agent SDK, Skill) compared on latency, cost and control."
badge: "NEW"
order: 4
section: "use-cases"
...
For the full setup guide, see [Local ComfyUI MCP](/mcp/comfyui-mcp-local/).
...
For the full TypeScript and Python implementation, see [Claude Agent SDK: generate and publish assets](/agents/agent-generation-assets/).
...
Get started: [Local ComfyUI MCP](/mcp/comfyui-mcp-local/).
...
Get started: [Claude Agent SDK: generate and publish assets](/agents/agent-generation-assets/).
...
- [Local ComfyUI MCP](/mcp/comfyui-mcp-local/): ComfyUI setup, Flux Schnell, MCP server, first prompt from Claude Code.
- [Claude Agent SDK: generate and publish assets](/agents/agent-generation-assets/): full agent implementation in Python and TypeScript, error handling, real cost breakdown.
- [Pilot a ComfyUI JSON workflow](/mcp/comfyui-workflow-piloting/): dynamically edit an exported workflow from Claude Code (sampler, ControlNet, prompt A/B testing).
- [Design an MCP workflow with Playwright](/mcp/workflow-design-playwright/): for browser-driven visual workflows, a complementary approach to image generation.
