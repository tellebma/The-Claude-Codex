...
Un agent Claude Code est une instance spécialisée avec son propre prompt système, ses outils dédiés et son contexte isolé. Il exécute des tâches multi-étapes en autonomie (planifier, exécuter, vérifier, itérer) sans polluer la conversation principale. Vous pouvez les invoquer directement par nom, ou les laisser être appelés en sous-tâche par d'autres agents.
...
<Faq>
  <FaqItem question="Qu'est-ce qu'un agent Claude Code ?">
  ...
  <FaqItem question="Quelle différence entre un agent et un subagent ?">
  ...
  <FaqItem question="Comment créer un agent Claude Code custom ?">
  ...
  <FaqItem question="Quand utiliser un agent plutôt qu'une slash command ?">
  ...
  <FaqItem question="À quel point les agents Claude Code sont-ils autonomes ?">
  ...
  <FaqItem question="Plusieurs agents peuvent-ils tourner en parallèle ?">
