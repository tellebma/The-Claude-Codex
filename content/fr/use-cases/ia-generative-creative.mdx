...
- [Piloter un workflow ComfyUI JSON](/fr/mcp/comfyui-workflow-piloting/) : éditer dynamiquement un workflow exporté depuis Claude Code (sampler, ControlNet, A/B de prompts).
- [Concevoir un workflow MCP avec Playwright](/fr/mcp/workflow-design-playwright/) : pour les workflows visuels pilotés par navigateur, une approche complémentaire à la génération d'images.
