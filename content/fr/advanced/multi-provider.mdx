...
claude --print --model claude-sonnet-5 "Implémente cette feature avec des tests"

# Opus pour des décisions complexes
claude --print --model claude-opus-4-8 "Conçois l'architecture de ce système distribué"
```
