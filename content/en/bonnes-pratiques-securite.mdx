...
description: "Essential guide to security best practices with Claude Code: API keys, data protection, code review, and compliance. Practical tips to use AI safely."
badge: "Security"
section: "content"
order: 8
...
<Callout type="info" title="A practical guide, not theoretical">
