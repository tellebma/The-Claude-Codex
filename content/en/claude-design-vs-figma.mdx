...
**Claude Design** (Anthropic Labs, April 17, 2026) generates designs, prototypes, slides and one-pagers through a conversation, not a canvas. **Verdict**: a complement to Figma for pro designers (production-ready), a credible replacement for PMs, devs and freelancers who want visuals without learning Figma. Full comparison below.
