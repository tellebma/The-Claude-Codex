...
claude --print --model claude-sonnet-5 "Implement this feature with tests"

# Opus for complex decisions
claude --print --model claude-opus-4-8 "Design the architecture for this distributed system"
```
