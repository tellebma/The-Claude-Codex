...
description: "Three-phase methodology for complex features. Feature-folder structure, six specialized subagents, mandatory human validation between phases. When to pick it."
section: "advanced"
order: 11
