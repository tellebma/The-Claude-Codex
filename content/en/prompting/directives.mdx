...
## 4. Les directives for examples (few-shot)
...
Here's how les quatre types de directives se combinent dans un prompt professionnel.
...
It's important to savoir où placer vos directives pour maximiser leur efficacité.
...
Now that you maîtrisez les directives, passez à la pratique avec des templates concrets.

- [Templates de prompts par métier](/prompting/templates) : Des prompts complets prêts à l'emploi
- [Common mistakes à éviter](/prompting/mistakes) : Les pièges les plus fréquents en prompting
