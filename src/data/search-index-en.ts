...
export const searchIndexEn: ReadonlyArray<SearchEntry> = [
  ...
  {
    title: "UI UX Pro Max: multi-stack design skill",
    description:
      "MIT skill by nextlevelbuilder with 67 UI styles, 161 palettes and 57 font pairings across 15 stacks. 86.5k GitHub stars as of 2026-06-02.",
  ...
  },
  {
    ...
    description:
      "MIT skill by Leon Lin with a family of per-style sub-skills (minimalist, brutalist, image-to-code). 31.7k GitHub stars as of 2026-06-02.",
  ...
  },
  {
    ...
    description:
      "25 hand-picked repos by category: harness, awesome lists, plugins, memory, token optimization, multi-agents, templates, system prompts.",
  ...
  },
  {
    ...
    description:
      "MCP servers to plug into Claude Code: dev tools (GitHub, Chrome DevTools, Playwright), data, builder frameworks, automation.",
  ...
  },
  {
    ...
    description:
      "Native OpenTelemetry for Claude Code, lifecycle event hooks, community dashboards: claude-hud, abtop, Claude-Code-Agent-Monitor, multi-agent observability.",
    href: "/advanced/observabilite-monitoring",
    section: "Advanced",
    keywords: [
      "observability",
      "monitoring",
  ...
  // Karpathy CLAUDE.md analysis
  {
    title: "Karpathy-Style CLAUDE.md: Analysis and FR Adaptation",
    description:
      "A close read of the so-called Karpathy CLAUDE.md: four principles against Claude Code drift, what transfers to a team setting, ready-to-paste FR template.",
  ...
  // GPT-5.6 vs Claude Sonnet 5
  {
    ...
    description:
      "GPT-5.6 (Sol, Terra, Luna) launched on July 9, 2026. Pricing, context window, TerminalBench and SWE-bench scores, and a METR finding worth knowing, measured against Claude Sonnet 5 and Fable 5.",
  ...
  },
  {
    ...
    href: "/content/opus-5-vs-new-gpt-models",
    section: "Content",
    keywords: [
      "opus 5",
      "claude-opus-5",
  ...
  },
  {
    ...
    href: "/content/kimi-k3-what-changes",
    section: "Content",
    keywords: [
      "kimi k3",
      "kimi-k3",
  ...
  },
  {
    ...
    href: "/content/kimi-k3-tech-report",
    section: "Content",
    keywords: [
      "kimi k3",
      "kimi-k3",
  ...
  },
  {
    ...
    description:
      "SWE-bench, BrowseComp, WebDev Arena: every model announcement comes with its share of impressive scores. Nine real pitfalls, verified in July 2026, to help you decode them yourself.",
    href: "/content/how-to-read-llm-benchmarks",
    section: "Content",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Kimi K3 tops the open-weight pack on the Intelligence Index, but licensing, hardware, and operations tell a different story. The real math for choosing.",
    href: "/content/open-weights-vs-closed-models",
    section: "Content",
    keywords: [
      "open weights",
      "closed models",
  ...
  },
  {
    ...
    href: "/content/real-cost-per-task",
    section: "Content",
    keywords: [
      "cost",
      "cost per task",
