...
|---|---|---|---|---|
| [`system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) | asgeirtj | MIT | ~40,100 | Dedicated folder [`Anthropic/claude-code/`](https://github.com/asgeirtj/system_prompts_leaks/tree/main/Anthropic/claude-code), per-model versioned prompts (as of 2026-06-03) |
