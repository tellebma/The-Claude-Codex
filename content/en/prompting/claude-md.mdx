...
## Example réel de CLAUDE.md bien écrit
...
Le contexte spécifique au projet : stack, architecture, conventions d'équipe. This is the file le plus important. Il est partagé avec l'équipe via le repo.
</Card>
...
Ces trois fichiers ont des rôles différents et complémentaires. Here's how les utiliser.
