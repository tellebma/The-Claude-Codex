...
description: "Garder le contexte d'une session Claude Code à l'autre : patterns claude-mem, graphify, hooks SessionStart, CLAUDE.md hiérarchique. 4 approches comparées."
order: 14
section: "advanced"
