...
<Card title="Sonnet 5: Best for coding" variant="accent">
**Use cases:**
...
<Card title="Opus 4.8: Deepest reasoning" variant="default">
**Use cases:**
...
| Sonnet 5 | Low | 3x | Excellent |
| Opus 4.8 | Medium | 5x | Maximum |

<Callout type="tip" title="Model selection strategy">
Start all your tasks with Sonnet 5. Switch to Opus 4.8 only when the task requires the deepest reasoning (critical architecture, security, complex algorithms). Use Haiku 4.5 for lightweight agents in your automated pipelines.
</Callout>
