...
claude --print --model claude-sonnet-4-6 "Implémente cette feature avec des tests"

# Opus pour des décisions complexes
claude --print --model claude-opus-4-6 "Conçois l'architecture de ce système distribué"
```
