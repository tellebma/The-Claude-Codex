...
/*
 * JSON-LD structured data: safe static schema from build-time constants,
 * serialized with JSON.stringify. No user input reaches this code path.
 * Same pattern used across all section index pages (mcp/page.tsx, etc.).
 */
