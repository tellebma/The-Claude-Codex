...
export const searchIndexFr: ReadonlyArray<SearchEntry> = [
  ...
  {
    title: "UI UX Pro Max : skill design multi-stack",
    description:
      "Skill MIT de nextlevelbuilder avec 67 styles UI, 161 palettes et 57 font pairings sur 15 stacks. 86.5k etoiles GitHub au 2026-06-02.",
  ...
  {
    title: "Taste Skill : framework anti-slop frontend",
    description:
      "Skill MIT de Leon Lin avec une famille de sous-skills par style (minimaliste, brutaliste, image-to-code). 31.7k etoiles GitHub au 2026-06-02.",
  ...
  // Claude Code + IA générative
  {
    ...
    keywords: [
      ...
      "ia générative claude code",
      "génération images ia",
      "workflow créatif claude code",
      "comfyui claude code",
      "flux replicate",
      "patterns intégration ia",
      "mcp local cloud agent skill",
      "générer des images claude code",
    ],
  },
  // Ecosystem
  {
  ...
  {
    title: "Memoire persistante entre sessions Claude Code",
    description:
      "Patterns pour garder le contexte d'une session a l'autre : CLAUDE.md hierarchique, hooks SessionStart, claude-mem, graphify. Comparaison et combinaison.",
  ...
  {
    title: "Observabilite et monitoring de Claude Code",
    description:
      "OpenTelemetry natif Claude Code, hooks d'evenements cycle de vie, dashboards community : claude-hud, abtop, Claude-Code-Agent-Monitor, multi-agent observability.",
  ...
  // Security review
  {
    title: "Commande /security-review : audit de securite dans Claude Code",
    description:
      "Detecter et corriger les failles SQL, XSS, secrets en clair et 7 autres familles directement depuis Claude Code, en local ou en CI via GitHub Action.",
  ...
  // Agent de génération d'assets
  {
    ...
    section: "Agents",
    keywords: [
      "agent génération assets",
      "agent claude images",
      "claude agent sdk images",
      "ia générative claude",
      "flux replicate api",
      "génération images agent",
      "optimisation webp",
      "upload storage assets",
      "pipeline assets visuels",
    ],
  },
  // Content (MDX)
  {
  ...
  // Internals Claude Code
  {
    ...
    description:
      "Ce que les system prompts fuites revelent sur l'architecture interne de Claude Code et comment en deduire de meilleurs CLAUDE.md.",
  ...
  {
    title: "gstack de Garry Tan : verdict apres un mois d'usage en equipe FR",
    description:
      "Review critique du stack Claude Code de Garry Tan (CEO YC). 35 commandes, philosophie solo founder, ce qui marche en contexte francais et ce qui coince.",
  ...
  {
    title: "CLAUDE.md facon Karpathy : analyse et version FR",
    description:
      "Decryptage du CLAUDE.md inspire d'Andrej Karpathy. 4 principes contre les derives de Claude Code, ce qui se transpose en equipe, modele FR pret a coller.",
