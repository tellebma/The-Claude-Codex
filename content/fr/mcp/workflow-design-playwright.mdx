...
- **Générer les visuels, pas seulement les valider** : [Claude Code + IA générative](/use-cases/ia-generative-creative) compare les façons de produire des images depuis Claude Code, du [MCP ComfyUI local](/mcp/comfyui-mcp-local) à l'agent.
