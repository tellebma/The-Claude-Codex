...
description: "Découvrez Agent Teams, la fonctionnalité expérimentale de Claude Code pour faire collaborer plusieurs agents sur un même projet. Configuration, cas d'usage et limites."
section: "agents"
order: 3
