...
Assurez-vous d'avoir les trois MCP configurés :
...
```bash
# Claude Code utilise Playwright en interne :
# -> browser_navigate("http://localhost:3000/page-inexistante")
# -> browser_take_screenshot()
#
# Le screenshot montre la page 404 avec le design moderne
# Claude Code analyse visuellement le résultat
```

### 4. Création de la PR (GitHub)

```bash
# Claude Code utilise GitHub en interne :
# -> git checkout -b feat/custom-404-page
# -> git add app/not-found.tsx
# -> git commit -m "feat: add custom 404 page"
# -> git push -u origin feat/custom-404-page
# -> create_pull_request(title, body, screenshots)
```
