...
- [Claude Council](/skills/claude-council) : Le pattern qui fait délibérer plusieurs avis (modèles ou personas) puis synthétise via un Chairman
- [Orchestrer une équipe d'agents Claude](/content/agent-team-orchestration) : Panorama daté des outils tiers (Paperclip, claude-office, CrewAI, LangGraph) pour piloter vos agents comme une organisation
