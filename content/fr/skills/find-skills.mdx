...
description: "Le méta-skill #1 sur skills.sh (1.6M installs en 2026) qui apprend à Claude Code à trouver, vérifier et installer le bon skill via npx skills."
section: "skills"
order: 5
...
- [Claude Council](/skills/claude-council) pour un exemple de pattern d'orchestration qu'on peut empaqueter en skill : faire délibérer plusieurs avis sur une décision difficile.
