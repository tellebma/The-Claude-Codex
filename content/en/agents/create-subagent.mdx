...
## Example 1 : Agent de review de code
...
## Example 3 : Agent de documentation
...
## Best practices pour les prompts d'agents
...
```bash
# In practice, vous formulez la demande ainsi :
...
Now that you savez créer des agents custom, découvrez comment les faire collaborer.
