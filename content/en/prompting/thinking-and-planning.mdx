...
<Card title="Opus 4.6: Deepest reasoning" variant="default">
**Use cases:**
...
| Opus 4.6 | Medium | 15x | Maximum |

<Callout type="tip" title="Model selection strategy">
Start all your tasks with Sonnet 4.6. Switch to Opus 4.6 only when the task requires the deepest reasoning (critical architecture, security, complex algorithms). Use Haiku 4.5 for lightweight agents in your automated pipelines.
</Callout>
...
- [Plan mode vs Thinking mode: the key differences](/content/plan-vs-thinking-mode): A focused comparison answering the most common questions about these two features
