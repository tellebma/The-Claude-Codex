...
Pour une revue ciblée sur la diff courante avant qu'elle atteigne la CI, la commande [`/security-review`](/advanced/security-review) native de Claude Code couvre SQL, XSS, auth, secrets et dépendances. Bon complément aux scanners SAST/SCA décrits ci-dessous.
</Callout>
