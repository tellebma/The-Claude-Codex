...
description: "Tutorial to build a Claude SDK agent that generates images via Flux/Replicate, optimizes to WebP and uploads. Architecture, TypeScript and Python code, cost."
badge: "NEW"
order: 11
section: "agents"
...
<Callout type="info" title="Indicative values">
The latency figures below (5-20s local, 4-10s cloud) are rough orders of magnitude observed on standard configurations. They vary with hardware (RTX 3090 vs RTX 4090 vs Apple M-series) and network quality.
</Callout>
...
<Step title="Agent execution loop" stepNumber={4} isLast>
...
<Callout type="info" title="Prices recorded on 2026-06-30">
The Flux prices below were read from the official Replicate pages on 2026-05-11. The Claude Sonnet 5 price was recorded on 2026-06-30 (same rate as the previous Sonnet 4.6 pricing: $3/$15 per MTok). They may change.
</Callout>

{/* source: replicate.com/black-forest-labs/flux-1.1-pro, consulted 2026-05-11 */}
{/* source: replicate.com/black-forest-labs/flux-dev, consulted 2026-05-11 */}
{/* source: replicate.com/black-forest-labs/flux-schnell, consulted 2026-05-11 */}
{/* source: docs.anthropic.com/en/about-claude/models/overview, consulted 2026-06-30 (Sonnet 5 update) */}
...
1. Use Flux Dev ($0.025) instead of Flux Pro for internal previews or secondary images. Quality is slightly lower, price is roughly 37% less.
...
- [Claude Code + generative AI overview](/use-cases/ia-generative-creative/): the four integration patterns compared, to place this agent among the full range of approaches.
- [The agent SDK in depth](/agents/agent-sdk/): go further on the execution loop, streaming and state management of a Claude agent.
