...
interface McpSlugPageProps {
  readonly params: Promise<{ locale: string; slug: string }>;
}

/**
 * Generate static params for all MCP MDX files.
...
export async function generateMetadata({
  params,
}: McpSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the MCP section.
 */
...
export default async function McpSlugPage({
  params,
}: McpSlugPageProps) {
  const resolvedParams = await params;
  ...
  const breadcrumbJsonLd = createBreadcrumbSchema([
    ...
    { name: "MCP", href: `/${resolvedParams.locale}/${SECTION}` },
