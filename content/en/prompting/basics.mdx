...
Un prompt efficace suit une structure en 4 parties. You don't need de toutes les utiliser à chaque fois, mais les connaître vous permet de les activer quand la situation l'exige.
...
4. Les instructions d'installation step by step"
```

### Principe 4 : Itérez progressivement

Ne demandez pas tout d'un coup. Construisez votre solution step by step, en vérifiant chaque étape avant de passer à la suivante.
...
## Examples avant/après : de débutant à optimisé
...
## Examples par profil : développeur, entrepreneur, étudiant, créatif
...
Vous maîtrisez maintenant les fondamentaux du prompting. Going further :
