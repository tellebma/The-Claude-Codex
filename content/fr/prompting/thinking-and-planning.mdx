...
<Card title="Opus 4.6 : Raisonnement le plus profond" variant="default">
**Cas d'usage :**
...
| Opus 4.6 | Moyenne | 15x | Maximale |

<Callout type="tip" title="Stratégie de sélection de modèle">
Commencez toutes vos tâches avec Sonnet 4.6. Passez à Opus 4.6 uniquement quand la tâche nécessite le raisonnement le plus profond (architecture critique, sécurité, algorithmes complexes). Utilisez Haiku 4.5 pour les agents légers dans vos pipelines automatisés.
</Callout>
...
- [Mode Plan vs Mode Thinking : les différences clés](/content/mode-plan-vs-thinking) : Un comparatif ciblé pour répondre aux questions les plus fréquentes sur ces deux fonctionnalités
...
- [Gestion du contexte](/prompting/context-management) : Optimisez l'utilisation de votre fenêtre de contexte
