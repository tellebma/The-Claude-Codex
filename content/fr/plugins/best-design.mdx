---
title: "Extensions design & frontend"
description: "Extensions Claude Code pour le design et le frontend : agent Frontend Design, MCP Playwright, 21st.dev Magic et skills UI. Installation et cas d'usage."
section: "plugins"
order: 4
...
L'agent Frontend Design est un fichier Markdown qui configure Claude Code comme un expert en design et développement frontend. Il fait partie de collections communautaires comme [Everything Claude Code](https://github.com/affaan-m/everything-claude-code).
...
|--------|------|---------|---------------|
| **Agent Frontend Design** | Agent communautaire | [Everything Claude Code](https://github.com/affaan-m/everything-claude-code) | Persona design persistant |
