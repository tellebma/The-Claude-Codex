...
- [MCP ComfyUI local, tutoriel complet](/fr/mcp/comfyui-mcp-local/) : mise en place de ComfyUI depuis zéro, installation de Flux Schnell, et connexion initiale à Claude Code.
- [Panorama Claude Code + IA générative](/fr/use-cases/ia-generative-creative/) : les quatre patterns d'intégration et la matrice de décision pour choisir entre local et cloud.
