...
interface AdvancedSlugPageProps {
  readonly params: Promise<{ locale: string; slug: string }>;
}

/**
 * Generate static params for all Advanced MDX files.
...
export async function generateMetadata({
  params,
}: AdvancedSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the Advanced section.
 */
...
export default async function AdvancedSlugPage({
  params,
}: AdvancedSlugPageProps) {
  const resolvedParams = await params;
