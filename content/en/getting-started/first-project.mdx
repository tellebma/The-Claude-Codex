...
- **Skills** ship with the CLI for the most common tasks (TDD, code review, frontend design). Browse them with `/skills` before reaching for an external library. See [the best Skills for 2026](/skills/best-skills).
