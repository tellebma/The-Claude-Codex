...
- [Pilot a ComfyUI JSON workflow](/en/mcp/comfyui-workflow-piloting/): dynamically edit an exported workflow from Claude Code (sampler, ControlNet, prompt A/B testing).
- [Design an MCP workflow with Playwright](/en/mcp/workflow-design-playwright/): for browser-driven visual workflows, a complementary approach to image generation.
