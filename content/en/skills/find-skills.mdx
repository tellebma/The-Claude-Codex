...
description: "The #1 meta-skill on skills.sh (1.6M installs in 2026) that teaches Claude Code to find, vet, and install the right skill via npx skills add."
section: "skills"
order: 5
...
- [Claude Council](/skills/claude-council) for an orchestration pattern you can package as a skill: making several opinions deliberate on a hard decision.
