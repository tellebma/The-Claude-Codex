...
description: "Discover Claude Code Skills: reusable workflows that automate your recurring tasks. How they work, how they differ from MCPs and plugins."
section: "skills"
order: 1
...
<Callout type="tip" title="Just getting started?">Si les concepts techniques vous semblent complexes, commencez par nos [cas d'usage concrets](/use-cases) pour voir Claude Code en action sans ecrire de code.</Callout>
...
Claude suit les instructions du Skill step by step. Si le Skill contient des variables (comme `$ARGUMENTS`), elles sont remplacées par les arguments fournis par l'utilisateur.
</Step>
...
Un Skill est simplement un fichier Markdown avec des instructions claires. Here is an example complet :
...
## Example concret : avant et après
...
Now that you comprenez le concept des Skills, let's get hands-on.

- [Top Skills recommandés 2026](/skills/best-skills) : Les Skills incontournables pour booster votre productivité
- [Créer un Skill custom step by step](/skills/create-custom) : Guide complet pour écrire vos propres Skills
