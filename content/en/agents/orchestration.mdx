...
## Example complet : pipeline de release
...
## Comparison avec d'autres outils multi-agents

Claude Code n'est pas le seul outil à proposer des agents. Here's how il se positionne face aux principales alternatives.
...
| **Use cases** | Développement logiciel | Tout type d'agent (marketing, recherche...) |
