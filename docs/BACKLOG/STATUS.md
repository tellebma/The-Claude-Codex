...
> Derniere mise a jour : 2026-05-29 (TUTO-6 batch 1 `skills` migre vers ArticleShell ; Content page redesign clos 100% #240/#243 + release prod 1.10.0 ; Vercel Metrics clos 9/11 VM-8/VM-12 descopes)
...
| [Tuto-pages article-shell 2026-05](EPIC-tuto-pages-article-shell-2026-05.md) | 10 | 3 | 1 | 6 | 35% 🔄 (TUTO-2 SectionPeers #215, TUTO-3 pilote #248, TUTO-5 getting-started complet #249 — composant TutoArticleContent factorise (TUTO-4) livre avec #248 ; TUTO-6 en cours : batch 1 `skills` migre (6 pages x2 locales) ; reste batches prompting/mcp/agents) |
