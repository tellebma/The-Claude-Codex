---
title: "Top MCP design & UI Claude Code"
description: "Les meilleurs MCP pour le design et l'UI avec Claude Code : Playwright, Chrome DevTools, 21st.dev Magic et Puppeteer. Tests E2E, debug web et composants UI."
section: "mcp"
order: 5
