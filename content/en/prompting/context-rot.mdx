...
description: "The longer a Claude Code session runs, the less context stays useful. Understand degradation, measure the dumb zone, use directed /compact and rewind."
section: "prompting"
order: 13
...
On the 1M token window (Opus 4.8), observed useful quality varies by profile:
