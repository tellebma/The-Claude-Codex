...
description: "How to keep context across Claude Code sessions: claude-mem, graphify, SessionStart hooks, hierarchical CLAUDE.md patterns. Four approaches, when to pick which."
order: 14
section: "advanced"
