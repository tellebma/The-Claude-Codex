...
description: "Definissez les permissions, les roles et les regles pour un deploiement Claude Code structure : audit, gestion centralisee des configs et politiques de mise a jour."
section: "enterprise"
order: 6
