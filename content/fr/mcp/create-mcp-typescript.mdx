...
description: "Tutoriel complet pour créer votre propre MCP Server avec le SDK TypeScript : tools, resources, prompts, test local et intégration Claude Code."
order: 7
section: "mcp"
...
- [Piloter un workflow ComfyUI JSON depuis Claude Code](/mcp/comfyui-workflow-piloting) : un MCP custom concret qui édite un workflow de génération d'images