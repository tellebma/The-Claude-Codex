...
<Callout type="tip" title="Voir aussi : audit du code projet">
Côté code, la commande [`/security-review`](/advanced/security-review) native de Claude Code couvre SQL, XSS, secrets et dépendances vulnérables sur ton propre code, en complément du durcissement MCP côté config.
</Callout>
