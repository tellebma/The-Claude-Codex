...
interface AgentsSlugPageProps {
  readonly params: { slug: string };
}

/**
 * Generate static params for all Agents MDX files.
...
/**
 * Resolve previous and next articles within the Agents section.
 */
 ...
 * E.g. "agents/create-subagent" -> "create-subagent"
 */
...
export default function AgentsSlugPage({
  params,
}: AgentsSlugPageProps) {
   ...
   * plugins/[slug]/page.tsx and skills/[slug]/page.tsx.
   */
