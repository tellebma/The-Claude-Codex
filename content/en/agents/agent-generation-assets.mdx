...
- [Claude Code + generative AI overview](/en/use-cases/ia-generative-creative/): the four integration patterns compared, to place this agent among the full range of approaches.
- [The agent SDK in depth](/en/agents/agent-sdk/): go further on the execution loop, streaming and state management of a Claude agent.
