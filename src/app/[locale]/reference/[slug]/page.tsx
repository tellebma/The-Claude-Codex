...
interface ReferenceSlugPageProps {
  readonly params: Promise<{ locale: string; slug: string }>;
}

/**
 * Generate static params for all reference MDX files.
...
export async function generateMetadata({
  params,
}: ReferenceSlugPageProps): Promise<Metadata> {
...
/**
 * Resolve previous and next articles within the reference section.
 */
...
export default async function ReferenceSlugPage({
  ...
  const breadcrumbJsonLd = createBreadcrumbSchema([
    ...
    { name: "Référence", href: `/${resolvedParams.locale}/${SECTION}` },
   ...
   * No user input reaches this path. Same pattern used in
   * mcp/[slug]/page.tsx, getting-started/[slug]/page.tsx.
   */
        ...
        <div className="relative px-4 pb-12 pt-16 sm:px-6 sm:pb-16 sm:pt-24 lg:px-8">
          ...
          <div className="text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-brand-500/20 bg-brand-500/10 px-4 py-1.5 text-sm text-brand-300">
              ...
              R&eacute;f&eacute;rence technique
            </div>
