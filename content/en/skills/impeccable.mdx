...
- **Huashu Design** (`alchaincyf/huashu-design`): focused on native HTML prototypes and decks. MIT-licensed since 2026-05-14 (the license has already changed once, re-check before commercial use). See the [Huashu Design page](/en/skills/huashu-design).
