...
| [Tuto-pages article-shell 2026-05](EPIC-tuto-pages-article-shell-2026-05.md) | 10 | 1 | 1 | 8 | 10% 🔄 (TUTO-2 SectionPeers merge #215 ; TUTO-1 decision tranchee option C ; TUTO-3 pilote debloque — SEO-1/2/3 livres + 14j ecoules) |

**Total projet** : 134/191 stories (70%) · ~313/441 SP livres (71%) — (VM-8 + VM-12 descopes : retires du denominateur)
