...
|---|---|---|---|---|
| [`system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) | asgeirtj | MIT | ~40 100 | Fichier dédié [`Anthropic/claude-code.md`](https://github.com/asgeirtj/system_prompts_leaks/blob/main/Anthropic/claude-code.md), version 2.1.120 datée du 27/04/2026 |
