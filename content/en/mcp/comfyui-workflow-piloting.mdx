...
- [Local ComfyUI MCP, full tutorial](/en/mcp/comfyui-mcp-local/): setting up ComfyUI from scratch, installing Flux Schnell, and the initial connection to Claude Code.
- [Claude Code + generative AI overview](/en/use-cases/ia-generative-creative/): the four integration patterns and the decision matrix for choosing between local and cloud.
