...
description: "Les situations concretes ou Claude Code n'est pas le bon choix : systemes temps reel, industrie reglementee sans revue, code de securite critique, prototypage rapide UI, et plus."
section: "limits"
order: 4
