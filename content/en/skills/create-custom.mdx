...
## Example : Skill "Deploy Checklist"
...
Pour les workflows longs, découpez en étapes numérotées avec des points de validation. Claude avance step by step et s'arrête si un checkpoint échoue.
...
### Example : Skill avec variable dynamique
