...
**Yes** -> Use a **community extension** (like [everything-claude-code](https://github.com/punkpeye/everything-claude-code)). These collections bundle agents, skills, and templates into a coherent folder, maintained by the community. Install them with `/install-github` or manually.
