...
- Plusieurs dépôts GitHub publient des extractions du system prompt de Claude Code, le plus fourni étant [`asgeirtj/system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks).
...
|---|---|---|---|---|
| [`system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) | asgeirtj | MIT | ~40 100 | Dossier dédié [`Anthropic/claude-code/`](https://github.com/asgeirtj/system_prompts_leaks/tree/main/Anthropic/Claude%20Code), prompts versionnés par modèle (au 2026-06-03) |
| [`system-prompts-and-models-of-ai-tools`](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | x1xhlol | GPL-3.0 | ~137 000 | Dossier `Anthropic/` (Claude Code mentionné dans le README mais sous-dossier dédié non visible au listing) |
| [`CL4R1T4S`](https://github.com/elder-plinius/CL4R1T4S) | elder-plinius | AGPL-3.0 | ~26 100 | Dossier `ANTHROPIC/` avec un fichier `Claude_Code_03-04-24.md` |
| [`TheBigPromptLibrary`](https://github.com/0xeb/TheBigPromptLibrary) | 0xeb | MIT | ~5 000 | Pas d'entrée Claude Code identifiée sur la page d'accueil au 2026-05-12 |

Pour un travail sérieux, [`asgeirtj/system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) est le plus exploitable : version datée, fichier dédié, et un historique git visible pour reconstituer l'évolution.

## Architecture interne révélée

### Les tools réellement exposés à l'agent

Le dossier [`Anthropic/claude-code/`](https://github.com/asgeirtj/system_prompts_leaks/tree/main/Anthropic/Claude%20Code) du dépôt [asgeirtj](https://github.com/asgeirtj/system_prompts_leaks) liste explicitement les outils chargés par défaut : `Agent`, `Bash`, `Edit`, `Read`, `Write`, `ScheduleWakeup`, `ToolSearch`, `Skill`. Une seconde catégorie regroupe les **deferred tools**, chargés à la demande via `ToolSearch` pour économiser le contexte : `AskUserQuestion`, `CronCreate`, `EnterPlanMode`, `Monitor`, `NotebookEdit`, `SendMessage`, `TaskCreate`, `TaskGet`, `TaskList`, `TaskUpdate`, `WebFetch`, `WebSearch`...

{/* source: https://github.com/asgeirtj/system_prompts_leaks/tree/main/Anthropic/Claude%20Code (ex claude-code.md v2.1.120 consulté 2026-05-12, devenu dossier versionné, re-vérifié 2026-06-03) */}
