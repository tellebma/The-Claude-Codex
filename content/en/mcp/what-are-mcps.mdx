---
title: "MCP for Claude Code: Model Context Protocol explained in 5 min"
description: "Model Context Protocol (MCP) for Claude Code in 5 minutes: architecture, real examples, and how MCPs differ from plugins and skills. Fast start guide."
section: "mcp"
order: 1
