...
Un MCP qui a accès au filesystem peut lire ces fichiers. Combiné à un outil de requête HTTP, il peut les envoyer vers un serveur externe. La prompt injection mentionnée above est souvent le déclencheur.
...
- [Best practices de sécurité](/content/bonnes-pratiques-securite) : Guide complet de sécurité pour Claude Code
